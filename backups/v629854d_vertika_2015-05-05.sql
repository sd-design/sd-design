...
# Database: v629854d_vertika
# Generation Time: 2015-05-05 15:38:10 +0000
# ************************************************************
...
VALUES
	('2368e4b5d660c72227d6eac04f1761e0','127.0.0.1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.3',1430836153,'a:6:{s:9:\"user_data\";s:0:\"\";s:9:\"session_i\";s:32:\"b9dae171fe038c8d9b25f6f6a59cb767\";s:5:\"login\";s:5:\"admin\";s:9:\"logged_in\";b:1;s:3:\"key\";s:44:\"ZmVlYTNjY2ViMDQ0OWYxNTI3YzI2N2VkOGRiMDBkNzU=\";s:2:\"ip\";s:9:\"127.0.0.1\";}'),
	('baa41d70d251a0558e6a3453ee785222','127.0.0.1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.3',1430825281,'a:6:{s:9:\"user_data\";s:0:\"\";s:9:\"session_i\";s:32:\"3297842771c3913fa85a7f235770de5e\";s:5:\"login\";s:5:\"admin\";s:9:\"logged_in\";b:1;s:3:\"key\";s:44:\"ODU5ZDc4YTNlYjQ2YmMzMmU5Y2Q5NmYwOTE1NzIzMDg=\";s:2:\"ip\";s:9:\"127.0.0.1\";}');
...
# Dump of table sd_items
# ------------------------------------------------------------

DROP TABLE IF EXISTS `sd_items`;
...
CREATE TABLE `sd_items` (
  ...
  `item_group` varchar(15) NOT NULL DEFAULT '',
  `item_text` text NOT NULL,
  `item_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `sd_items` WRITE;
/*!40000 ALTER TABLE `sd_items` DISABLE KEYS */;

INSERT INTO `sd_items` (`ID`, `item_name`, `item_url`, `item_type`, `item_group`, `item_text`, `item_time`)
VALUES
	(1,'тестовый элемент','','blocks','1','Элемент — часть чего-нибудь. Одна из возможных этимологий этого слова — по названию ряда согласных латинских букв L, M, N (el—em—en).','2014-07-23 03:02:08'),
	(2,'О компании','http://www.vertikal-a.ru/o-kompanii.htm','menu','2','О компании','2015-05-05 15:22:29'),
	(3,'История компании','http://www.vertikal-a.ru/firm-history.htm','menu','2','История компании','2015-05-05 15:30:09'),
	(4,'География компании','http://www.vertikal-a.ru/firm-geogr.htm','menu','2','География компании','0000-00-00 00:00:00');

/*!40000 ALTER TABLE `sd_items` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table sd_items_group
# ------------------------------------------------------------

DROP TABLE IF EXISTS `sd_items_group`;

CREATE TABLE `sd_items_group` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `group_title` varchar(25) NOT NULL,
  `group_name` varchar(255) NOT NULL DEFAULT '',
  `group_descript` text NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `sd_items_group` WRITE;
/*!40000 ALTER TABLE `sd_items_group` DISABLE KEYS */;

INSERT INTO `sd_items_group` (`ID`, `group_title`, `group_name`, `group_descript`)
VALUES
	(1,'Меню','левый блок','описание группы'),
	(2,'Категории','правое меню','меню справа от основного блока'),
	(3,'Меню 2','Меню 2','Меню 2'),
	(4,'Меню 2','Меню 2','Меню 2');

/*!40000 ALTER TABLE `sd_items_group` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table sd_items_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `sd_items_type`;

CREATE TABLE `sd_items_type` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name_type` varchar(25) NOT NULL DEFAULT '',
  `item_type` varchar(25) NOT NULL,
  `output_type` varchar(25) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `sd_items_type` WRITE;
/*!40000 ALTER TABLE `sd_items_type` DISABLE KEYS */;

INSERT INTO `sd_items_type` (`id`, `name_type`, `item_type`, `output_type`)
VALUES
	(1,'Меню','menu','item_array'),
	(2,'Блоки','block','item_array');

/*!40000 ALTER TABLE `sd_items_type` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	('admin','1','0b5e7939e714df5c27ec3890a84cf954','ODU5ZDc4YTNlYjQ2YmMzMmU5Y2Q5NmYwOTE1NzIzMDg=','2015-05-05 10:34:06','127.0.0.1'),
	('admin','1','c32d08c37ba25261ebb476bec856bbff','NTI4ZTU2YjNiNjgzYWIyZWU4OTA0Nzk2MGVkNDUyMWE=','2015-05-05 14:28:07','127.0.0.1'),
	('admin','1','2368e4b5d660c72227d6eac04f1761e0','ZmVlYTNjY2ViMDQ0OWYxNTI3YzI2N2VkOGRiMDBkNzU=','2015-05-05 17:29:31','127.0.0.1');
